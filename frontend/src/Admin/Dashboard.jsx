...
function Dashboard() {
  ...
  return (
    <div className="font-poppins antialiased fixed">
      <div
        id="view"
        className={`h-full w-screen flex flex-row fixed ${
          ...
          <div className="space-y-6 md:space-y-10 mt-10">
            ...
            <div className="flex border-2 border-gray-200 rounded-md focus-within:ring-2 ring-teal-500">
              <input
                ...
                placeholder="Search"
              />
              <button className="rounded-tr-md rounded-br-md px-2 py-3  md:block">
                <svg
