...
const navigateToPayment = () => {
  ...
  return (
    <Link to={{ pathname: "/payment", state: { totalPrice } }}>Proceed to Checkout</Link>
  );
};
  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="mt-16 w-[900px] absolute top-0 mx-64 backdrop-blur-[1px] p-3">
          ...
          <div className="mt-3  text-center">
            ...
            <NavLink to={"/payment"}>
            <button id="animateButton" onClick={navigateToPayment()} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              process to Checkout
            </button></NavLink>
          </div>
        </div>
